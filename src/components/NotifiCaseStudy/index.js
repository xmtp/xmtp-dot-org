        ...
        <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div class="lg:ml-auto lg:pl-4 lg:pt-4">
            ...
            <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-red-600">
              ...
              <p class="mt-6 text-3xl font-bold tracking-tight sm:text-4xl">Deliver real-time notifications </p>
              <p class="mt-6 text-lg leading-7">Via Notifi, publishers can segment and send broadcast messages to their list of subscribers. Since Coinbase Wallet respects users’ opt-in preferences stored on the XMTP network, publishers can feel confident that their messages will reach subscribers’ main inbox.</p>
              <p class="mt-6 text-lg leading-7">Starting today, GMX users can receive key notifications, including:</p>
              <dl class="pl-4 my-8 max-w-xl space-y-6 text-base leading-7 lg:max-w-none">
                <div class="relative pl-12">
                  <dt class="inline font-semibold text-lg">
