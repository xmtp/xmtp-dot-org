...
const sdkcards = [
  {
    ...
    thirdLink: { name: 'GitHub repo', link: 'https://github.com/xmtp/xmtp-js' },
    secondLink: { name: 'Quickstart', link: '/docs/tutorials/quickstarts/js-quickstart' },
    firstLink: { name: 'Reference', link: '/docs/references/javascript/classes/Client' },
    logo: '/img/js.svg',
    theme: 'sunrise',
  },
 {
    ...
    thirdLink: { name: 'GitHub repo', link: 'https://github.com/xmtp/xmtp-ios' },
    secondLink: { name: 'Quickstart', link: '/docs/tutorials/quickstarts/swift-quickstart' },
    firstLink: { name: 'Reference', link: '/docs/references/swift-sdk-reference' },
    logo: '/img/swift.svg',
    theme: 'midnight',
  },
  {
    ...
    firstLink: { name: 'Reference', link: '/docs/references/dart-sdk-reference' },
    secondLink: { name: 'Quickstart', link: '/docs/tutorials/quickstarts/dart-quickstart' },
    thirdLink: { name: 'GitHub Repo', link: 'https://github.com/xmtp/xmtp-flutter' },
    logo: '/img/dart.svg',
    theme: 'daylight',
  },
  {
    ...
    secondLink: { name: 'GitHub repo', link: 'https://github.com/xmtp/xmtp-android' },
    firstLink: { name: 'Quickstart', link: '/docs/tutorials/quickstarts/kotlin-quickstart' },
    logo: '/img/kotlin.svg',
    theme: 'sunrise',
  },
