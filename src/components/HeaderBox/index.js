...
export const HeaderBox = ({ title, subtitle }) => {
  return (
    <div className="bg-white dark:bg-neutral-900 rounded-lg border-black dark:border-neutral-700 border border-solid px-8 py-6 w-432 m-4 flex flex-col justify-between ">
