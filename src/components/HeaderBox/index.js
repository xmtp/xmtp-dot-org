...
export const HeaderBox = ({ title, subtitle }) => {
  return (
    <div className="bg-white first:ml-0 last:mr-0 dark:bg-neutral-900 rounded-lg border-black dark:border-neutral-700 border border-solid px-8 py-6 w-432 mx-0 my-4 md:mx-4 flex flex-col justify-between ">
