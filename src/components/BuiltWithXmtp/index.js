...
const BuiltWithXmtp = () => {
  ...
  return (
    <div>
          ...
          <div class="mx-auto max-w-7xl md:max-w-7xl px-6 md:px-16 pb-8 pt-4 md:pt-4 lg:flex md:pb-32">
            <div class="mx-auto max-w-5xl shrink-0 lg:mx-0 md:pt-24">
              ...
              <div class="mx-auto max-w-full shrink-0 lg:mx-0 lg:max-w-2xl">
                <dl class="mx-auto mt-8 mb-8 grid max-w-4xl grid-cols-1 gap-x-0 gap-y-6 md:gap-y-10 text-white sm:gap-y-16 lg:grid-cols-3">
                  <div class="flex flex-col gap-y-1 border-none md:border-solid border-0 border-r border-white/30 pr-8">
                    <dt class="text-lg/6 text-gray-400">Identities</dt>
                    <dd class="order-first text-2xl md:text-3xl font-semibold tracking-tight">2 Million+</dd>
                  </div>
                  <div class="flex flex-col gap-y-1 border-none md:border-solid border-0 border-r border-white/30 pr-10 ml-0 md:ml-8">
                    <dt class="text-lg/6 text-gray-400">of Developers</dt>
                    <dd class="order-first text-2xl md:text-3xl font-semibold tracking-tight">1,000s</dd>
                  </div>
                  <div class="flex flex-col gap-y-1 border-none md:border-solid border-0 border-r border-white/30 pr-10 ml-0 md:ml-8">
                    <dt class="text-lg/6 text-gray-400">Apps</dt>
                    <dd class="order-first text-2xl md:text-3xl font-semibold tracking-tight">60+</dd>
                  </div>
                </dl>
      ...
      <div class="pt-8 pb-4 bg-gray-50 rounded-3xl my-6">
        <div class="mx-auto max-w-full">
          ...
          <div class="relative flex overflow-x-hidden">
            <div class="py-4 animate-marquee whitespace-nowrap">
              ...
              <img class="mx-8 max-h-8 md:max-h-12 object-contain" src="img/logo-converse.svg" alt="Converse" width="200" height="64"></img>
      ...
      <div id="trynow" class="bg-white pb-16 pt-16 rounded-3xl mb-8">
        <div class="mx-auto max-w-2xl px-0 md:px-6 lg:max-w-7xl lg:px-8">

          <div class="pb-8 md:col-end-1 md:w-full md:max-w-2xl md:pb-8">
            <p class="text-sm/4 md:text-base font-semibold uppercase tracking-wider leading-tight text-gray-400">Secure messaging for everyone</p>
            ...
            <p class="max-w-3xl text-base md:text-lg font-normal">Download one of the many apps powered by XMTP now and send a message on a secure and decentralized network</p>
          </div>

          <div class="mt-0 grid gap-4 lg:grid-cols-2 lg:grid-rows-2">
            
            <div class="relative lg:row-span-2">
              <div class="absolute inset-0 rounded-3xl bg-white"></div>
                <div class="h-full rounded-3xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto w-full">
                  <div class="h-full rounded-3xl p-2">
                    <div class="h-full rounded-3xl bg-white p-0 shadow-2xl">
                      <article class="h-full relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-transparent">
                        <div class="px-6 pt-6 md:px-8 md:pt-8">
                          <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm/6 text-gray-900">
                            <img src="img/converse-logo-full-white.svg" class="h-14 mb-2"></img>
                          </div>
                          <h3 class="mt-1 text-lg/6 font-normal text-gray-900">
                            <p class="text-white">
                              <span class="absolute inset-0"></span>
                              Converse Messenger is a messaging app for decentralized, secure, end-to-end encrypted conversations.
                            </p>
                            <div class="mt-2 flex flex-wrap gap-x-4 gap-y-4">
                              <a href="#">
                                <img src="img/apple-store.svg" class="h-9 md:h-10 mt-2"></img>
                              </a>
                              <a href="#">
                                <img src="img/google-play.svg" class="h-9 md:h-10 mt-2"></img>
                              </a>
                            </div>
                          </h3>
                          {/* <div class="absolute inset-0 -z-10 bg-gradient-to-b from-white via-gray-100/40"></div> */}
                        </div>
                        <div class="min-h-[28rem] md:min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                          <img src="img/ConverseCTA.png" alt="" class="absolute inset-0 -z-20 w-full h-full object-cover"></img>
                        </div>
              ...
              <div class="pointer-events-none absolute inset-px rounded-3xl shadow ring-1 ring-black/5"></div>
            </div>

            <div class="relative max-lg:row-start-1 h-full rounded-3xl max-lg:mx-auto w-full">
              <div class="absolute inset-0 rounded-3xl bg-white"></div>
                <div class="h-full rounded-3xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto w-full p-2">
                  <div class="h-full rounded-3xl bg-white p-0 shadow-2xl">
                    <article class="h-full relative isolate flex flex-col justify-start overflow-hidden rounded-2xl bg-transparent">
                        <div class="px-6 pt-6 md:px-8 md:pt-8 max-w-sm">
                          <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm/6 text-gray-900">
                          <img src="img/coinbase-wallet-black.svg" class="h-8 mb-2"></img>
                          </div>
                          <h3 class="mt-1 text-lg/6 font-normal text-gray-900">
                            <p class="text-gray-900">
                              <span class="absolute inset-0"></span>
                              Your key to the world of crypto. Explore thousands of tokens while sending messages right on your phone.
                            </p>
                            <div class="mt-2 flex flex-wrap gap-x-4 gap-y-4">
                              <a href="#">
                                <img src="img/apple-store.svg" class="h-9 md:h-10 mt-2"></img>
            ...
            <div class="relative max-lg:row-start-2 h-full rounded-3xl max-lg:mx-auto w-full">
              <div class="absolute inset-0 rounded-3xl bg-white"></div>
                <div class="h-full rounded-3xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto w-full p-2">
                  <div class="h-full rounded-3xl bg-white p-0 shadow-2xl">
                    <article class="h-full relative isolate flex flex-col justify-start overflow-hidden rounded-2xl bg-transparent">
                        <div class="px-6 md:px-8 pt-6 md:pt-8 max-w-sm">
                          <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm/6 text-gray-900">
                          <img src="img/family-logo-black.svg" class="h-8 mb-2"></img>
                          </div>
                          <h3 class="mt-1 text-lg/6 font-normal text-gray-900">
                            <p class="text-gray-900">
                              <span class="absolute inset-0"></span>
                              Choose to send a "gm" to a fren or a peer-to-peer payment using a beautifully designed app.
                            </p>
                            <div class="mt-2 flex flex-wrap gap-x-4 gap-y-4">
                              <a href="#">
                                <img src="img/apple-store.svg" class="h-9 md:h-10 mt-2"></img>
              ...
              <div class="pointer-events-none absolute inset-px rounded-3xl shadow ring-1 ring-black/5 max-lg:rounded-t-[2rem]"></div>
            </div>
      ...
      <div class="relative isolate overflow-hidden bg-gray-950 pt-16 md:pt-24 pb-24 md:pb-32 rounded-3xl mb-6">
        <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
          ...
          <div class="absolute left-[calc(50%-4rem)] top-10 -z-10 transform-gpu blur-3xl sm:left-[calc(50%-18rem)] lg:left-48 lg:top-[calc(50%-30rem)] xl:left-[calc(50%-24rem)]" aria-hidden="true">
            ...
            <div class="lg:col-end-1 lg:w-full lg:max-w-3xl lg:pb-8 mb-8 md:mb-0">
              ...
              <h2 class="max-w-3xl text-balance text-3xl md:text-5xl font-semibold tracking-tight text-white">How apps and wallets use XMTP</h2>
              <p class="text-gray-300 max-w-3xl text-base md:text-lg font-normal">Learn about the connected and resilient ecosystem for seamless communication across apps and wallets</p>
            </div>

            <div class="mx-auto grid max-w-full auto-rows-fr grid-cols-1 gap-4 lg:mx-0 lg:max-w-none lg:grid-cols-4">
              ...
              <div class="rounded-3xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto w-full">
                <div class="rounded-3xl p-2 shadow-md shadow-black/5">
                  <div class="rounded-3xl bg-white p-0 shadow-2xl ring-1 ring-black/5">
                    <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-4 pb-4 pt-72">
              ...
              <div class="rounded-3xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto w-full">
                <div class="rounded-3xl p-2 shadow-md shadow-black/5">
                  ...
                  <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-4 pb-4 pt-72">
                      <img src="img/coinbase-wallet-header.png" alt="" class="absolute inset-0 -z-10 w-full h-full object-cover"></img>
                      <div class="absolute inset-0 -z-10 bg-gradient-to-t from-black via-gray-900/40"></div>
                      <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-gray-900/10"></div>

                      <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm/6 text-gray-300">
                        <img src="img/coinbase-wallet-white.svg" class="h-7 mb-2"></img>
                      </div>
                      <h3 class="mt-3 text-lg/6 font-semibold text-white">
                        <a href="#" class="text-white hover:text-gray-400 hover:no-underline">
                          <span class="absolute inset-0"></span>
              ...
              <div class="rounded-3xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto w-full">
                <div class="rounded-3xl p-2 shadow-md shadow-black/5">
                  <div class="rounded-3xl bg-white p-0 shadow-2xl ring-1 ring-black/5">
                  <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-4 pb-4 pt-72">
                      <img src="img/converse-header.png" alt="" class="absolute inset-0 -z-10 w-full h-full object-cover"></img>
                      <div class="absolute inset-0 -z-10 bg-gradient-to-t from-black via-gray-900/40"></div>
                      <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-gray-900/10"></div>
                      
                      <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm/6 text-gray-300">
                        <img src="img/converse-logo-full-white.svg" class="h-9 mb-2"></img>
                      </div>
                      <h3 class="mt-3 text-lg/6 font-semibold text-white">
                        <a href="#" class="text-white hover:text-gray-400 hover:no-underline">
                          <span class="absolute inset-0"></span>
              ...
              <div class="rounded-3xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto w-full">
                <div class="rounded-3xl p-2 shadow-md shadow-black/5">
                  ...
                  <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-4 pb-4 pt-72">
                      ...
                      <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm/6 text-gray-300">
                        <img src="img/notifi-logo-white.svg" class="h-6 mb-2 mt-3"></img>
                      </div>
                      <h3 class="mt-3 text-lg/6 font-semibold text-white">
                        <a href="#" class="text-white hover:text-gray-400 hover:no-underline">
                          <span class="absolute inset-0"></span>
      ...
      <div class="bg-gray-50 py-24 rounded-3xl mb-6">
        <div class="mx-auto max-w-2xl px-0 lg:max-w-7xl md:px-8">
          ...
          <div class="mt-4 grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            <div class="relative lg:row-span-2">
