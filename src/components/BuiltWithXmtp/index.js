    ...
    <ul className="list-none grid grid-cols-1 md:grid-cols-2 gap-6 px-0">
      {ListOfDevelopers.map(developer => 
        <li className="relative group" key={developer.name}>
          <a className="rounded border-solid rounded-md border-slate-200 dark:border-slate-600 flex justify-center py-6 mb-3" href={developer.href}>
        ...
        <li className="relative group">
          <a className="rounded border-solid rounded-md border-slate-200 dark:border-slate-600 flex justify-center py-6 mb-3 bg-gradient-to-r from-indigo-900 to-red-500" href="https://forms.gle/p1VgVtkoGfHXANXt5" alt="Submit your">
