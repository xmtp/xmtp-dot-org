          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
            <div class="px-6 lg:px-0 lg:pr-4 lg:pt-4">
              <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
                ...
                <p class="mt-2 text-pretty text-5xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Best in Class Security</p>
                ...
                <p class="mt-2 text-base leading-8 text-gray-900"><a href="/docs/concepts/invitation-and-message-encryption" className="underline underline-offset-2">Read more</a> about security and privacy guarantees.</p>
              </div>
            </div>
          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
            ...
            <div class="px-6 lg:px-0 lg:pl-4 lg:pt-4">
              <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
                ...
                <p class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Universal Identity Support</p>
                ...
                <p class="mt-2 text-base leading-8 text-gray-900"><a href="/docs/concepts/v3/identity" className="underline underline-offset-2">Read more</a> about XMTP’s Universal Identity Support</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
            <div class="px-6 lg:px-0 lg:pr-4 lg:pt-4">
              <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
                ...
                <p class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">A global, decentralized distribution network</p>
                <p class="mt-6 text-lg leading-8 text-gray-600">XMTP supports the broadest range of identity types for registration.</p>
                ...
                <p class="mt-6 text-base leading-8 text-gray-600">This flexibility allows users to authenticate and communicate using any identity they control, without being tied to a specific identity provider or platform.</p>
                <p class="mt-2 text-base leading-8 text-gray-900"><a href="https://community.xmtp.org/t/archived-decentralizing-xmtp-a-minimum-viable-proposal/510" className="underline underline-offset-2">Read more</a> about XMTP’s Decentralization efforts.</p>
              </div>
            </div>
            <div class="sm:px-6 lg:px-0">
                <div class="mx-auto max-w-2xl sm:mx-0 sm:max-w-none">
