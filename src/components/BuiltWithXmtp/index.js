...
const BuiltWithXmtp = () => {
  // Setting a consistent max width for text blocks and the developers list
  const consistentMaxWidth = {
    maxWidth: "1200px",
    margin: "0 auto",
    padding: "0 16px",
  };
  ...
  return (
    <div>
      <div style={consistentMaxWidth}>
        ...
        <h3 className="px-6">
          Pick any app. Message any identity. Own your communications.
        </h3>
      </div>
              ...
              <div className="flex-shrink-0">
                <a
                  ...
                  <img
                    ...
                    alt={`this is an image of the ${developer.name} icon`}></img>
                </a>
              </div>
