  ...
  return (
    ...
    <div>
      ...
      <div className="mt-8 px-6">
          <h2 className="text-2m font-semibold leading-7 sm:text-2m text-center">Try these apps built with XMTP</h2>
          <h3 className="text-2m font-semibold leading-7 sm:text-2m mb-8 text-center">Use your favorites to manage and own your messages and networks</h3>
      </div>   
