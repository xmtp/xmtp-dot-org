---
sidebar_label: Intro to the XMTP client SDK for Flutter
sidebar_position: 1
---
import Feedback from '/src/components/Feedback'

# Introduction to the XMTP client SDK for Flutter

The [XMTP client SDK for Flutter](https://github.com/xmtp/xmtp-js) is a XXXXXXXX implementation of an XMTP client for use with XXXXXXX, iOS, Android, and web apps.
...
To learn how to build an app with the XMTP client SDK for Flutter, see the [Quickstart](/docs/client-sdk/flutter/tutorials/placeholder).

To learn about the classes and interfaces provided by the XMTP client SDK for Flutter, see the [Reference](/docs/client-sdk/flutter/reference/placeholder).
