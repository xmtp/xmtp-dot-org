---
sidebar_label: Intro to the XMTP client SDK for JavaScript
sidebar_position: 1
---
import Feedback from '/src/components/Feedback'

# Introduction to the XMTP client SDK for JavaScript

The [XMTP client SDK for JavaScript](https://github.com/xmtp/xmtp-js) is a TypeScript implementation of an XMTP client for use with JavaScript and React apps.
...
To learn how to build an app with the XMTP client SDK for JavaScript, see the [Quickstart](/docs/client-sdk/javascript/tutorials/quickstart).

To learn about the classes and interfaces provided by the XMTP client SDK for JavaScript, see the [Reference](/docs/client-sdk/javascript/reference/classes/Client).
