...
1. Create an `AudioCodec` class that encodes and decodes the content type. We will put this in the file that creates the XMTP Client. 
  ```javascript
...
1. Register your ImageCodec custom content type with the message API client. For example:
