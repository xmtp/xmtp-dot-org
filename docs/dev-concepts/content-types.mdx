...
Your custom content type WILL NOT be supported by other apps and will display fallback text in them instead.
...
If another app wants to display your custom content type, they must implement your custom content type in their code exactly as it's defined in your app.
