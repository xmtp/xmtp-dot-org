...
- [Everyname](https://everyname.xyz)
    - Name and Address Middleware Protocol to resolve any onchain name service. Example implementation in [xmtp-inbox-web](https://github.com/xmtp-labs/xmtp-inbox-web/pull/284)
