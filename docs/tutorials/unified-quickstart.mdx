...
# Quickstart for XMTP SDKs

XMTP SDKs provide an implementation of an XMTP message API client (client).

Build with an SDK to provide messaging between blockchain wallet addresses, delivering on use cases such as wallet-to-wallet messaging and dapp-to-wallet notifications.
...
<Tabs groupId="sdk">
<TabItem value="xmtp-js" label="xmtp-js" default>
...
<TabItem value="xmtp-android" label="xmtp-android">

This is an orange 🍊

</TabItem>
<TabItem value="xmtp-swift" label="xmtp-swift">

This is a banana 🍌

</TabItem>
<TabItem value="xmtp-flutter" label="xmtp-flutter">
...
You can get a list of all conversations that have 1 or more messages.
