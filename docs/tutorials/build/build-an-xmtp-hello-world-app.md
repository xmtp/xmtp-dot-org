...
To learn more about creating and enabling an XMTP identity, see [Sign to send and receive messages using apps built with XMTP](https://xmtp.org/docs/concepts/account-signatures).
...
* Learn about [XMTP development concepts](/docs/concepts/introduction)
