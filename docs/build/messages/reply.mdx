...
Note that the user experience of replies in iMessage and Slack follows more of a threaded pattern, where messages are collected into logical groupings. This pattern isn't supported by this reply content type. If you'd like to request support for a threaded reply pattern, [post an XIP idea](https://github.com/orgs/xmtp/discussions/categories/xip-ideas).
