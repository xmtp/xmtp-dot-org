...
You don't need to manually register or use the codecs in your application code. You just need to work with the high-level objects and methods provided by the SDK.
...
Send the remote attachment message
