...
Upload an encrypted attachment anywhere where it will be accessible via an HTTPS GET request. This will depend on what storage provider you use which may vary based on your needs. On xmtp.chat, we use Web3 Storage, but don't formally endorse any particular tool.
