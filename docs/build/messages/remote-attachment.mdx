...
Upload an encrypted attachment anywhere where it will be accessible via an HTTPS GET request. This will depend on what storage provider you use. On xmtp.chat, we use Web3 Storage, but there are a number of options.
