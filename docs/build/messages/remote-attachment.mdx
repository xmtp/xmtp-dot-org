...
You are welcome to provide feedback by commenting on the [Remote attachment content type XIP](https://github.com/xmtp/XIPs/blob/main/XIPs/xip-17-remote-attachment-content-type-proposal.md).
