...
- [**Primary Inbox**](https://docs.airstack.xyz/airstack-docs-and-faqs/guides/xmtp/spam-filters/primary-inbox): Some criteria that can be checked for a user to be included in the primary inbox are:
