...
<ul>
  ...
  <li><a href="https://github.com/xmtp/xmtp-react-native/tree/main/example" class="plausible-event-name=Quickstart">Group Chat</a><br/><small>React Native example app. Use it to help you build your own group chat with XMTP.</small></li>
</ul>
