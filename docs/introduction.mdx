...
- [End-to-end encryption](/docs/concepts/v2/invitation-and-message-encryption) of **messages that the user owns and controls**

- Providing an **[interoperable inbox](/docs/concepts/interoperable-inbox)** accessible across apps built with XMTP

- Relaying messages to the **progressively decentralized** [XMTP network](/docs/concepts/v2/architectural-overview#network-layer)
...
To explore more apps built with XMTP, see [Built with XMTP](https://xmtp.org/).
...
To learn more, see [Works with XMTP](/docs/faq#what-works-with-xmtp).

### Protocol overview

A user can send and receive encrypted XMTP messages using an app with an embedded XMTP [**client**](/docs/concepts/v2/architectural-overview#client-layer), authenticating using a wallet signature. XMTP network [**nodes**](/docs/concepts/v2/architectural-overview#network-layer) transport and persist the user's messages.
