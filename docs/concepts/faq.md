...
To learn more, see [Wallet apps](/docs/concepts/works-with-xmtp#wallet-apps).
...
XMTP Labs is working toward a phased decentralization of the network. To learn more see, [XMTP: The journey to decentalization](/blog/journey-to-decentralization).
