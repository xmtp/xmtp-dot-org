...
To learn how to build an app with the XMTP SDK, see [Quickstart for the XMTP JavaScript SDK](/docs/tutorials/quickstarts/js-quickstart).

To learn about XMTP SDK classes and interfaces, see [XMTP JavaScript SDK Reference](/docs/references/javascript/classes/Client).
