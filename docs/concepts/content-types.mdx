...
To learn how to use standard content types when developing a client app, see [Use content types](/docs/tutorials/use-content-types).
...
To learn how to use custom content types when developing a client app, see [Use content types](/docs/tutorials/use-content-types).
