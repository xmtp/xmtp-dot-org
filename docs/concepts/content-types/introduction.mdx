...
To learn how to use standard content types when developing a client app, see [Use content types](/docs/concepts/content-types/introduction).
...
To learn how to use custom content types when developing a client app, see [Use content types](/docs/concepts/content-types/introduction).
...
To learn more about the difference between standard and custom content types, see [Content types with XMTP](/docs/concepts/content-types/introduction).
