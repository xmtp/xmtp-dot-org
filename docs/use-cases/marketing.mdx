...
<div className="chain-list">
  <a href="https://absolutelabs.io/" className="chain-item ">
    <img src={useBaseUrl('/img/absolute-logo.jpg')} alt="Absolute Labs logo" width="80" height="80" loading="eager" />
    <span>Absolute Labs</span>
  </a>
  <a href="https://www.bello.lol/" className="chain-item ">
    <img src={useBaseUrl('/img/bello.png')} alt="Bello logo" width="80" height="80" loading="eager" />
    <span>Bello</span>
  </a>
  <a href="https://www.withblaze.app/" class="chain-item">
    <img alt="Blaze logo" src={useBaseUrl('/img/blaze-logo.png')} width="80" height="80" loading="eager" />
    <span>Blaze</span>
  </a>
  <a href="https://getpercs.com/" class="chain-item">
    <img alt="Percs logo" src={useBaseUrl('/img/percs-logo.jpg')} width="80" height="80" loading="eager" />
    <span>Percs</span>
  </a>
  <a href="https://www.paragraph.xyz/" className="chain-item ">
    <img src={useBaseUrl('/img/logo-paragraph.png')} alt="Paragraph logo" width="80" height="80" loading="eager" />
    <span>Paragraph</span>
  </a>
</div>
