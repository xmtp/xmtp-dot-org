...
[Lens Prorotocol 🌿](https://docs.lens.xyz/) apps use XMTP to provide secure, private messaging to their users. Using decentralized social media apps users are able to discover new friends and communicate with them.
